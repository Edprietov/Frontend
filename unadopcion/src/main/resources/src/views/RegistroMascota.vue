            ...
            <div class="card-body">
              <form class="text-left" id="formulario" @submit="formaEnviar">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-row">
                      <label class="control-label col-sm-2" for="animalNombre"
                    ...
                    <br />
                    <div class="form-row">
                      <label class="control-label col-sm-2" for="animalLugar"
                    ...
                    <br />
                    <div class="form-row">
                      <br /><strong class="control-label col-sm-2"
                        >Fotografia:</strong
                      >
                      <div class="col-sm-10">
